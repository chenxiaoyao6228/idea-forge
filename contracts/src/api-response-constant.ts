...
export enum ErrorCodeEnum {
  ...
  // Workspace 
  WorkspaceNotFoundOrNotInWorkspace = 6001,
  
  // Subspace related errors (using 6100 range for subspaces)
  SubspaceNotFound = 6101,
  SubspaceAdminRoleRequired = 6102,
  SubspaceAccessDenied = 6103,
  UserNotInWorkspace = 6104,
  UserAlreadyInSubspace = 6105,
}
...
export const ErrorCodeMsg: ErrorCodeMsg = {
  ...
  // Workspace 
  [ErrorCodeEnum.WorkspaceNotFoundOrNotInWorkspace]: "Workspace not found or not in workspace",
  
  // Subspace related messages
  [ErrorCodeEnum.SubspaceNotFound]: "The specified subspace could not be found.",
  [ErrorCodeEnum.SubspaceAdminRoleRequired]: "Admin role is required to perform this action on the subspace.",
  [ErrorCodeEnum.SubspaceAccessDenied]: "You do not have access to this subspace.",
  [ErrorCodeEnum.UserNotInWorkspace]: "The user is not a member of the workspace.",
  [ErrorCodeEnum.UserAlreadyInSubspace]: "The user is already a member of this subspace.",
};

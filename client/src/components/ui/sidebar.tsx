/*
 * added time: 2024-11-27
 * changelog of this component: https://ui.shadcn.com/docs/components/sidebar#changelog
 */
...
import { mergeButtonRefs } from "@/utils/common";
...
const SidebarMenuSubItem = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(({ ...props }, ref) => <div ref={ref} {...props} />);

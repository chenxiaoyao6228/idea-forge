...
describe('processDropEvent', () => {
  ...
  const mockAllDocuments = {
    'mydoc1': { id: 'mydoc1', index: 'a', title: 'My Doc 1', subspaceId: null, parentId: null },
    'mydoc2': { id: 'mydoc2', index: 'b', title: 'My Doc 2', subspaceId: null, parentId: null },
    'mydoc3': { id: 'mydoc3', index: 'c', title: 'My Doc 3', subspaceId: null, parentId: null },
    'subdoc1': { id: 'subdoc1', index: 'a', title: 'Sub Doc 1', subspaceId: 'space1', parentId: null },
    'child1': { id: 'child1', index: 'a', title: 'Child 1', subspaceId: null, parentId: 'mydoc1' },
  };

  const mockGetMyDocsRootDocuments = vi.fn(() => mockMyDocsDocuments);
  ...
  describe('My-docs area reorder', () => {
    it('should reorder document within my-docs to top position', () => {
      ...
      const params: DropEventParams = {
        ...
        getMyDocsRootDocuments: mockGetMyDocsRootDocuments,

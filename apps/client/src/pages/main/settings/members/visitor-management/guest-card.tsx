...
import { ChevronDown, ChevronRight, X, User, Mail, Calendar, FileText } from "lucide-react";
...
export const GuestCard = ({ guest, onUpdatePermission, onRemoveDocumentAccess }: GuestCardProps) => {

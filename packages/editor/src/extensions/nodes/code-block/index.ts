 ...
 * This is the base isomorphic version that works on both client and server.
 * Client can extend this to add React views and syntax highlighting.
...
export const CodeBlock = Node.create<CodeBlockOptions>({
  ...
  // Client can override addProseMirrorPlugins() to provide syntax highlighting + paste handlers
});
